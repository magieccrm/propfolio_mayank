                    ...
                    >
                      <div className="card">
                        <div className="card-header text-center">
                          <span>
                            Use variables to call dynamic data. For user details
                            - For date - For payment method For invoice number
                            For amount payable For due date and For invoice
                            items call{" "}
                          </span>
                        </div>
                                  ...
                                  <div className="card">
                                    ...
                                    >
                                      <div className="card-body">
                                        ...
                                        remote trade copier. Its allow you to
                                        copy trades almost instantly between
                                        hundreds of MT4 accounts through the use
                                        of technology. Many of the industries
                                        leading money managers use FXCopier to
                                        easily manage multiple client accounts
                                        in tandem.
                                      </div>
                                    </div>
                                  </div>
                                  <div className="card">
                                    ...
                                    >
                                      <div className="card-body">
                                        ...
                                        special trade copier. If you want to use
                                        this copier for business purpose or
                                        other commercial pupose then directly
                                        contact with www.fxcopier.co.uk.
                                      </div>
                                    </div>
                                  </div>
                                  <div className="card">
                      ...
                      <form     onSubmit={agentSubmit}>
                        <div className="col-sm-12 col-xs-12 pt-3">
                          <div className="service-con">
                            <div className="cards">
                              <div className="row" >
                              <div className="col-sm-12 col-xs-12 pt-3" style={{ display:none}}>
                                <div className="col-md-3">
                                  <div className="form-group">
                                      ...
                                      <div className="form-group">
                                        <input
                                          ...
                                          onChange={(e) =>
                                            setData({
                                              ...data,
                                              lead_source_name: e.target.value,
                                            })
                                          }
                                          className="form-control"
                                      ...
                                      <div className="form-group">
                                        <input
                                          ...
                                          onChange={(e) =>
                                            setlostreasonset({
                                              ...status,
                                              lost_reason_name: e.target.value,
                                            })
                                          }
