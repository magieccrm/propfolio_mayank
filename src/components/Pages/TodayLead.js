...
import AllFollowupstableToday from "./AllFollowupstableToday";
function TodayLead() {
...
<div className="pt-3">
  <div className="container pl-0">
     <AllFollowupstableToday sendDataToParent={handleChildData}  dataFromParent={none}/>
  </div>
